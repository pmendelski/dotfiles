...
return function(client, bufnr)
	...
	if supports_format == true then
		buf_set_keymap("n", "<c-s>", ':execute \'lua require("plugin/lspconfig/actions").format()\' | :w<cr>', opts)
		buf_set_keymap("i", "<c-s>", '<c-o>:execute \'lua require("plugin/lspconfig/actions").format()\' | :w<cr>', opts)
		buf_set_keymap("x", "<c-s>", '<esc>:execute \'lua require("plugin/lspconfig/actions").format()\' | :w<cr>', opts)
	else
